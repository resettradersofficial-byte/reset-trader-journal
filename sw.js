const CACHE = 'reset-trader-v5-vapid-20260913';
const APP_SHELL = ['./','./index.html','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./audio/pre-trade-check.mp3','./audio/post-trade-journal.mp3'];
